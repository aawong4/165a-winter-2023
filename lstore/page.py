...
class Physical_Page:
    ...
    def write(self, offset, value):
        ...
        self.data[next_entry: next_entry + lstore.config.BYTES_PER_ENTRY] = value.to_bytes(lstore.config.BYTES_PER_ENTRY, 'big')
        self.num_records += 1

    # Returns data of page
    def read(self, offset):
        row_number = self.data[offset * lstore.config.BYTES_PER_ENTRY: offset * lstore.config.BYTES_PER_ENTRY + lstore.config.BYTES_PER_ENTRY]
